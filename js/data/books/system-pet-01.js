...
const systemPetBook01 = {
  ...
  scenes: {
      ...
      choices: [
        {
          id: 'accept_fate',
          text: '默默抱起小熊猫',
          outcomes: [{ weight: 100, to: 'first_system_event', textAfterChoice: '你沉默地抱起小熊猫。它的身体温温热热，在你怀里缩成一团。周围的嘲笑声像针一样扎在背上。\n\n「废物……」你在心里默念这个词，嘴角不自觉地抽了抽。\n\n从小到大，你听过太多次类似的评价。成绩中游，家境普通，长相也不算出众——你早就习惯了被人看低。但这一次不一样。\n\n怀里这只小东西，哪怕全世界都说它是废物，它也是你的灵宠。你的。\n\n你低下头，正对上小熊猫黑溜溜的眼睛。它歪着头看着你，尾巴摇了摇，像是在问：「你在难过吗？」\n\n你还没来得及回答，一个冰冷的声音忽然在脑海中响起——\n\n「神级选择系统，已激活。」\n\n你猛地愣住。\n\n什么？\n\n「宿主：未知。灵宠：变异小熊猫（F级，隐藏潜力：未知）。系统功能：在特定场景触发选择任务，选项奖励根据选择强度浮动。」\n\n你眨了眨眼，又眨了眨眼。\n\n不是幻觉。那个声音清晰得像是在你脑子里装了个喇叭。\n\n你下意识看向四周——没人注意到你的异常。王磊还在笑，李浩还在起哄，张萌正担忧地看着你。\n\n你深吸一口气，努力让自己看起来正常。\n\n「选择任务触发。」\n\n那个声音再次响起。\n\n你的视野边缘，似乎有什么东西在闪烁。' }]
        }
      ],
    ...
    classroom_system: {
      ...
      systemPrompt: {
        title: '【选择任务触发】',
        text: '检测到权威压制场景。\n\n赵老师与王磊联合嘲讽，系统已生成对应选项。\n\n提示：本场景的选择将直接影响一周后的实战考核结果。'
      },
      choices: [
        {
          id: 'class_apologize',
